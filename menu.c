...
void menu_update_and_draw(GSGLOBAL *gsGlobal, settings_t *settings, int visible) {
    ...
    int y = 60;
    gsKit_fontm_print_scaled(gsGlobal, gsGlobal->Width / 2 - 140, y, 2, 0.9f,
        GS_SETREG_RGBA(255,255,255,0x80), "SETARI LAVA LAMP (START = inchide)");
    y += 24;
    ...
    gsKit_fontm_print_scaled(gsGlobal, 100, y, 2, 0.8f, GS_SETREG_RGBA(255,255,0,0x80), line);
    y += 20;
